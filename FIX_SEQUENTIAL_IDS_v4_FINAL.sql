-- ============================================
-- FIX: Auto-generate sequential IDs per user (v4 - FINAL COMPLETE)
-- ============================================
...
-- STEP 2: DROP POLICIES ON RELATED TABLES (matches, match_statuses, match_notes)
-- ============================================
...
-- STEP 4: ALTER COLUMN TYPES (candidates, clients, matches)
-- ============================================
...
-- STEP 5: UPDATE EXISTING DATA TO SEQUENTIAL IDS
-- ============================================
...
-- Update matches table references
UPDATE matches m
...
-- STEP 6: CREATE AUTO-INCREMENT FUNCTIONS
-- ============================================
