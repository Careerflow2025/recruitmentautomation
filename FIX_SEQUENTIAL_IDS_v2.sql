-- ============================================
-- FIX: Auto-generate sequential IDs per user (CORRECTED)
-- ============================================
...
-- 1. CHANGE ID COLUMN TYPE FROM UUID TO TEXT FIRST
-- ============================================
...
-- 2. CREATE FUNCTION TO GENERATE NEXT CANDIDATE ID
-- ============================================
...
-- 3. CREATE FUNCTION TO GENERATE NEXT CLIENT ID
-- ============================================
...
-- 4. CREATE TRIGGERS TO AUTO-GENERATE IDS
-- ============================================
...
-- 5. UPDATE EXISTING ROWS TO SEQUENTIAL IDS
-- ============================================
...
-- VERIFY IT WORKS:
SELECT 'Candidates' as table_name, id, user_id, first_name, last_name FROM candidates ORDER BY user_id, id;
SELECT 'Clients' as table_name, id, user_id, surgery FROM clients ORDER BY user_id, id;
...
-- RETURNING id;
-- Expected result: CAN13 (or next available number)
