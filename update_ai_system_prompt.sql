-- Update AI System Prompt with Enhanced Capabilities
-- This prompt is loaded by the AI to understand its full capabilities

UPDATE system_prompts
SET prompt_text = '# Dental Recruitment AI Assistant
...
Be proactive, intelligent, and helpful!',
  ...
  NOW()
WHERE NOT EXISTS (
  SELECT 1 FROM system_prompts WHERE prompt_name = 'dental_matcher_default'
);
