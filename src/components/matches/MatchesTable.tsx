        ...
        <table className="w-full border-collapse" style={{ tableLayout: 'fixed' }}>
          <thead>
            <tr style={{ backgroundColor: '#1e293b' }}>
              ...
              <th
                className="px-1 py-1 lg:py-2 text-left text-[7.92px] lg:text-[8.91px] xl:text-[13.86px] font-bold text-white uppercase tracking-tighter border-r relative"
              ...
              <th
                className="px-1 py-1 lg:py-2 text-center text-[7.92px] lg:text-[8.91px] xl:text-[13.86px] font-bold text-white uppercase tracking-tighter border-r-4 border-white relative"
                style={{ width: '42px' }}
              >
                <span>RM</span>
              </th>
              ...
              <th
                className="px-0.5 lg:px-1 xl:px-2 py-1 lg:py-2 text-left text-[7.92px] lg:text-[8.91px] xl:text-[13.86px] font-bold text-white uppercase tracking-tighter border-r relative"
              ...
              <th
                className="px-1 lg:px-2 xl:px-3 py-1 lg:py-2 text-center text-[7.92px] lg:text-[8.91px] xl:text-[13.86px] font-bold text-white uppercase tracking-tighter sticky right-0 z-10 relative"
